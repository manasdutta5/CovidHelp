...
public class VaccineFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        WebView vaccineWebView = root.findViewById(R.id.vaccineWebView);
        WebSettings webSettings = vaccineWebView.getSettings();
        webSettings.setJavaScriptEnabled(true);

        String covinURL = "https://www.cowin.gov.in/";
        vaccineWebView.loadUrl(covinURL);
